...
BOOL BASSDEF(proxyBASS_ChannelPlay)(DWORD handle, BOOL restart);
BOOL BASSDEF(BASS_ChannelStop)(DWORD handle);
BOOL BASSDEF(proxyBASS_ChannelPause)(DWORD handle);
BOOL BASSDEF(proxyBASS_ChannelSetAttribute)(DWORD handle, DWORD attrib, float value);
...
BOOL BASSDEF(proxyBASS_ChannelSetPosition)(DWORD handle, QWORD pos, DWORD mode);
